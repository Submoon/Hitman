...
# respective places.
bot = Discordrb::Bot.new token: 'MjczNTU4OTQzNTgwNTUzMjE3.C2lT7w.oRFC9Q1aQUq30Wd-5kCd69YI_IM', client_id: 273558943580553217
...
bot.message(content: 'tts Ping!!') do |event|
  event.respond '/tts Je vais manger vos parents et étrangler vos yaourts!'
end
